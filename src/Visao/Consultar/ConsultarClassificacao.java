...
public class ConsultarClassificacao extends javax.swing.JFrame {
    ...
    public void AtualizaTable(){
        ...
        ClassificacaoDAO db = new ClassificacaoDAO(con);
        List<Classificacao> lista = new ArrayList<>();
        lista = db.ListarClassificacao();
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        ClassificacaoDAO db = new ClassificacaoDAO(con);
        List<Classificacao> lista = new ArrayList<>();
        lista = db.Pesquisar_Cod_Classificacao(cod);
        DefaultTableModel tbm = (DefaultTableModel) jTable1.getModel();
        while(tbm.getRowCount() > 0){
            tbm.removeRow(0);
        }
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        ClassificacaoDAO db = new ClassificacaoDAO(con);
        List<Classificacao> lista = new ArrayList<>();
        lista = db.Pesquisar_Nome_Classificacao(jTextField1.getText());
        DefaultTableModel tbm = (DefaultTableModel) jTable1.getModel();
        while(tbm.getRowCount() > 0){
            tbm.removeRow(0);
        }
