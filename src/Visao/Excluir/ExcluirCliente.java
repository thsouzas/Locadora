...
public class ExcluirCliente extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jComboBox1.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Selecione uma Cliente" }));
        ...
        getContentPane().add(jPanel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 130, 490, 200));
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if(nome.equals("Selecione uma Cliente")){
            JOptionPane.showMessageDialog(null, "Nenhum cliente selecionado","Video Locadora",JOptionPane.QUESTION_MESSAGE);
        }else{
