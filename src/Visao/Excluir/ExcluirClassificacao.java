...
public class ExcluirClassificacao extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jComboBox1.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Selecione uma Classificação" }));
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if(nome.equals("Selecione uma Classificação")){
            JOptionPane.showMessageDialog(null, "Nenhum classificação selecionado","Video Locadora",JOptionPane.QUESTION_MESSAGE);
        }else{
