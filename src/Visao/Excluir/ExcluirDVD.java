...
public class ExcluirDVD extends javax.swing.JFrame {
    ...
    public void AtualizarCombo(){
        ...
        for(DVD b : lista){
            jComboBox1.addItem(""+b.getData_compra());
        }
    ...
    private void initComponents() {
        ...
        jComboBox1.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Selecione um DVD" }));
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if(nome.equals("Selecione um DVD")){
            JOptionPane.showMessageDialog(null, "Nenhum dvd selecionado","Video Locadora",JOptionPane.QUESTION_MESSAGE);
        }else{
